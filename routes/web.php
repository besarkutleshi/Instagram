...
Route::post('p/like','LikeController@store');
Route::get('likes/{postid}','LikeController@GetLikes');
...
Route::get('/explore', 'PostController@explore');
...
Route::get('/p/c/delete/{comment}', 'CommentController@destroy')->name('comment.delete');
